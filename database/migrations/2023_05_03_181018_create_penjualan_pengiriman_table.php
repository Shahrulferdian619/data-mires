...
class CreatePenjualanPengirimanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('second_mysql')->create('penjualan_pengiriman', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('nomer_pengiriman_penjualan')->unique();
            $table->date('tanggal');
        ...
        Schema::connection('second_mysql')->create('penjualan_pengiriman_rinci', function (Blueprint $table) {
            $table->id();
            // relasi ke tabel barang
            $table->unsignedBigInteger('produk_id');

            // relasi ke tabel pengiriman_penjualan
            $table->unsignedBigInteger('penjualan_pengiriman_id');
            $table->foreign('penjualan_pengiriman_id')
                ->references('id')
                ->on('penjualan_pengiriman')
                ->onDelete('cascade');
        ...
        Schema::connection('second_mysql')->create('penjualan_pengiriman_berkas', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('penjualan_pengiriman');
    }
}
