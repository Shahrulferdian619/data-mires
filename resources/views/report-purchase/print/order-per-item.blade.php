...
<body class="A4" >
    <section class="sheet padding-10mm">
        <div class="text-center">
            ...
            <h2 style="text-transform: uppercase;color: rgba(2, 218, 2, 0.952);" >Pembelian Barang</h2>
            @php
                $grandTotal = 0;
            @endphp
            ...
            <table style="width: 100%;margin-top:20px" >
                <thead>
                    <tr>
                        <th style="border-bottom: 1px solid #000; width: 30%; padding-bottom: 5px;text-align: start" >Kode Barang</th>
                ...
                <tbody>
                    @foreach ($order as $item)
                        <tr>
                            <td style="text-align: start" >{{ $item->barang->kode_barang }}</td>
