...
<html>
<head>
	<title>Laporan Tagihan Pembelian | PT MIRES MAHISA GLOBALINDO</title>
...
<body>
    ...
    <div style="width:100%; text-align: center; margin-bottom: 10px; margin-top: -20px"><strong style="font-size: 20px;">TAGIHAN PEMBELIAN</strong> </div>
	...
	<table class="table table-bordered table-sm" style="width:100%">
		<thead>
			<tr class="text-center-row">
				...
				<th style="width:15%">Nomer Faktur</th>
		...
		<tbody>
			...
			<tr>
				...
				<td>{{ date('d-m-Y', strtotime($fakturpembelian->tanggal)) }}</td>
                <td>
