...
<html>
<head>
	<title>Laporan Sales | PT MIRES MAHISA GLOBALINDO</title>
...
<body>
    ...
    <div style="width:100%; text-align: center; margin-bottom: 10px; margin-top: -20px"><strong style="font-size: 20px;">SALES</strong> </div>
	...
	<table class="table table-bordered table-sm" style="width:100%">
		<thead>
			<tr class="text-center-row">
				...
				<th style="width:45%">Nama Sales</th>
				<th style="width:50%">Target Total</th>
				<th style="width:50%">Bonus Presentase</th>
