...
<body class="A4" >
    <section class="sheet padding-10mm">
        <div class="text-center">
            ...
            <h2 style="text-transform: uppercase;color: #800000;margin-top:-10px" >Penjualan Per Barang (Kuantitas)</h2>
            ...
            <table style="width: 100%;margin: auto;" >
                <thead>
                    <tr>
                        ...
                        <th style="border:none;text-align:left;" >Total Penjualan (kuantitas)</th>
