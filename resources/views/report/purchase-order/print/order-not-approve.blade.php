...
<body class="A4" >
    <section class="sheet padding-10mm">
        <div class="text-center">
            ...
            <h2 style="text-transform: uppercase;color: #800000;margin-top:-10px" >Pembelian Belum Disetujui</h2>
            ...
            <table style="width: 100%;margin-top:20px" >
                <thead>
                    <tr>
                        ...
                        <th style="border:none;text-align: start" >Komisaris</th>
                ...
                <tbody>
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td style="text-align: start" >{{ $item->approve_komisaris == 0 ? 'Belum disetujui' : 'Sudah disetujui' }}</td>
