...
<body class="A4" >
    <section class="sheet padding-10mm">
        <div class="text-center">
            ...
            <h2 style="text-transform: uppercase;color: #800000;margin-top:-10px" >Pembelian Per Supplier ( Vendor )</h2>
            @php
                $grandTotal = 0;
            @endphp
            @php
            ...
            <table style="width: 100%;margin-top:20px" >
                @foreach ($data as $item)
                    ...
                    @endphp
                        ...
                        @endforeach
                        <tr>
                            <td colspan="7" > <hr style="border:none;border-top:1px solid gray;height: 1px;shadow:none;" > </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="4" > </td>
                            <td colspan="3" > <hr style="border:none;border-top:1px solid gray;height: 1px;shadow:none;" > </td>
                        </tr>
                        <tr>
                            <td colspan="7" > </td>
                        </tr>
