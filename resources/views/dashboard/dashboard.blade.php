            ...
            <div class="col-lg-6 col-md-3 col-6">
                <div class="card">
                    <div class="card-body pb-50">
                        ...
                        <h2 class="font-weight-bolder mb-1">{{$directs}}</h2>
            ...
            <div class="col-lg-6 col-md-3 col-6">
                <div class="card">
                    <div class="card-body pb-50">
                        ...
                        <h2 class="font-weight-bolder mb-1">{{$onlines}}</h2>
                        <div id="statistics-order-chart"></div>
                    </div>
                </div>
            </div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <canvas class="bar-chart-omset-penjualan chartjs" data-height="400"></canvas>
            </div>
        </div>
    </div>
</div>
