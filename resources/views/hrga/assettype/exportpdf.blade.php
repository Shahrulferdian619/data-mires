...
<html>
<head>
	<title>Laporan Kategori Asset | PT MIRES MAHISA GLOBALINDO</title>
...
<body>
    ...
    <div style="width:100%; text-align: center; margin-bottom: 10px; margin-top: -20px"><strong style="font-size: 20px;">KATEGORI ASSET</strong> </div>
	...
	<table class="table table-bordered table-sm" style="width:100%">
		<thead>
			<tr class="text-center-row">
				...
				<th style="width:45%">Nama Kategori Asset</th>
				<th style="width:50%">Keterangan</th>
			</tr>
		</thead>
		<tbody>
			@php $i=1 @endphp
			@foreach( $assettype as $ast )
			<tr>
				<td align="center" valign="center">{{ $i++ }}.</td>
				<td>{{ $ast->tipe_asset }}</td>
                <td>{{ $ast->keterangan }}</td>
			</tr>
			@endforeach
		</tbody>
	</table>
