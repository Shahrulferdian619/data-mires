...
@section('header')
Create Asset ( Tambah Data Asset )
@endsection
...
<form action="/admin/asset" method="POST">
<div class="col-md-6">
   <div class="card">
        <div class="card-body">
            @csrf
            ...
            <input type="text" class="form-control" name="harga_perolehan" id="harga_perolehan" value="{{ old('harga_perolehan') }}">
            
            <label>Masukkan Kuantitas <span class="text-danger"><i>*</i></span></label>
            <input type="text" class="form-control" name="kuantitas" value="{{ old('kuantitas') }}">
