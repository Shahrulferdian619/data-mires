...
@section('header')
Supplier Category (Kategori Supplier)
@endsection
...
<div class="card">
    <!-- <div class="card-header with-border">
        <a href="/admin/tipesupplier/create" class="btn btn-outline-primary">
    ...
    <div class="col-md-3 form-group">
                                ...
                                <div class="btn-group dropleft">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{ route('admin.tipesupplier.exportPDF') }}" >Export PDF</a>
                                        <a class="dropdown-item" target="_blank" href="{{ route('admin.tipesupplier.printPDF') }}">Print</a>
                                    </div>
                                </div>
        ...
        <!-- <div class="table-responsive">
            <table class="table-tipesupplier table table-condensed table-striped table-bordered">
                <thead>
                    <tr>
                        <th>Nama Tipe Supplier</th>
                        <th>Deskripsi Tipe Supplier</th>
                        <th>Action</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach($tipesupplier as $tipe)
                        <tr>
                            <td>{{ $tipe->tipesupplier }}</td>
                            <td>{{ $tipe->deskripsi_tipesupplier }}</td>
                            <td>
                                <a href="/admin/tipesupplier/{{ $tipe->id }}" class="badge badge-light-secondary">
        ...
        <table class="table table-hover table-bordered" id="tipesupplier-table">
            <thead>
...
<script>
      ...
      $(document).ready(function() {
          $('#tipesupplier-table').DataTable({
              processing: false,
              info: true,
              serverSide: true, //aktifkan server-side 
              ajax: {
                  url: "{{ route('admin.tipesupplier.index') }}",
                  type: 'GET'
              },
              "pageLength": 10,
              "aLengthMenu": [
              ...
              columns: [
                  ...
                  {
                      data: 'deskripsi_tipesupplier',
                      name: 'deskripsi_tipesupplier'
                  },
                  {
                      data: 'actions',
                      name: 'actions'
          ...
          $('#tipesupplier-table').parent().addClass('table-responsive');
      });
