...
<html>
<head>
	<title>Laporan Kategori Barang | PT MIRES MAHISA GLOBALINDO</title>
...
<body>
    ...
    <div style="width:100%; text-align: center; margin-bottom: 10px; margin-top: -20px"><strong style="font-size: 20px;">KATEGORI BARANG</strong> </div>
	...
	<table class="table table-bordered table-sm" style="width:100%">
		<thead>
			<tr class="text-center-row">
				...
				<th style="width:45%">Nama Tipe Supplier</th>
				<th style="width:50%">Deskripsi Tipe Supplier</th>
			</tr>
		</thead>
		<tbody>
			@php $i=1 @endphp
