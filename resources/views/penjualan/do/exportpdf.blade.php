...
<html>
<head>
	<title>Laporan Kiriman Penjualan | PT MIRES MAHISA GLOBALINDO</title>
...
<body>
    ...
    <div style="width:100%; text-align: center; margin-bottom: 10px; margin-top: -20px"><strong style="font-size: 20px;">KIRIMAN PENJUALAN</strong> </div>
	...
	<table class="table table-bordered table-sm" style="width:100%">
		<thead>
			<tr class="text-center-row">
				...
				<th style="width:15%">Nomor DO</th>
				<th style="width:15%">Tanggal DO</th>
		...
		<tbody>
			...
			<tr>
				...
				<td>{{ $do->do_nomer }}</td>
				<td>{{ date('d-m-Y', strtotime($do->do_tanggal)) }}</td>
                <td>{{ $do->alamat_do }}</td>
                <td>{{ $do->pic_do }}</td>
			</tr>
			@endforeach
