...
<!-- tabel untuk isian barang Sales Order -->
<div class="row mt-1">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
...
<!-- End of - tabel untuk isian barang Sales Order -->

@if (!empty($so->berkas))
<!-- Konten untuk berkas Sales Order -->
<div class="row mt-1">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
...
<!-- End of - Konten untuk berkas Sales Order -->
@endif


@include('penjualan.button.so')
