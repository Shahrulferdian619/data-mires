...
<head>
    <title>Delivery Order : {{$do->do_nomer}}</title>
    <meta charset="UTF-8">
    ...
    <div style="width:100%; padding:10px; border: 1px solid black">
        ...
        <table style="width: 100%; margin-top: 10px">
            ...
            <tr>
                ...
                <td>{{ $do->pelanggan->detail_alamat }}</td>
                <td><strong>Tanggal Surat Jalan</strong></td>
                <td>{{ date('Y-m-d', strtotime($do->created_at)) }}</td>
            </tr>
            <tr>
                <td><strong>No. Telp</strong></td>
                <td>{{ $do->pelanggan->handphone_pelanggan }}</td>
            ...
            <tr>
                ...
                <td>{{ $so->ekspedisi }}</td>
                <td><strong>Tanggal SO</strong></td>
                <td>{{ $so->so_tanggal }}</td>
            </tr>
            <tr>
