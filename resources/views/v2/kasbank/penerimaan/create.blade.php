...
<form action="{{route('kasbank.penerimaan.store')}}" method="post" enctype="multipart/form-data">
    @csrf
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-borderless table-striped">
                    <tr>
                        <td style="width: 300px;">Diterima ke*</td>
                        <td>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody id="rincian-akun">
                        <tr class="rincian-akun-0">
                            ...
                            <td>
                                <input type="text" name="rincian[0][nominal]" id="nominal-penerimaan-0" value="0" class="form-control rincian-nominal" required>
                            </td>
                            <td>
    ...
    $(document).ready(function() {
        ...
        $('.btn-tambah-akun').click(function() {
            const html_akun = `<tr>
                                    ...
                                    <td>
                                        <input type="text" name="rincian[${row_akun}][nominal]" id="nominal-penerimaan-${row_akun}" value="0" class="form-control rincian-nominal" required>
                                    </td>
                                    <td>
