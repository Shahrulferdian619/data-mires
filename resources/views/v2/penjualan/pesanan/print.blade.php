...
<head>
    <title>Pesanan Penjualan : {{ $pesanan_penjualan->nomer_pesanan_penjualan }}</title>
    <meta charset="UTF-8">
    ...
    <div style="width:100%; padding:10px; border: 1px solid black">
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td>{{ $pesanan_penjualan->nomer_pesanan_penjualan }}</td>
            </tr>

            <tr>
                <td><strong>Tanggal</strong></td>
                <td>{{ date('d-m-Y',strtotime($pesanan_penjualan->tanggal)) }}</td>
            </tr>

            <tr>
                <td><strong>Sales</strong></td>
                <td>{{ $pesanan_penjualan->sales->nama_sales }}</td>
            </tr>
        </table>
        ...
        <table style="width: 100%; margin-top: 10px">
            <tr>
                ...
                <td>{{ $pesanan_penjualan->pelanggan->nama_pelanggan }}</td>
            </tr>
            <tr>
                <td><strong>Alamat Customer</strong></td>
                <td>{{ $pesanan_penjualan->pelanggan->detil_alamat }} {{ $pesanan_penjualan->pelanggan->provinsi }}</td>
            </tr>
            <tr>
                <td><strong>No. Telp</strong></td>
                <td>{{ $pesanan_penjualan->pelanggan->no_handphone }}</td>
            </tr>
            <tr>
                <td><strong>Ekspedisi</strong></td>
                <td>{{$pesanan_penjualan->ekspedisi}}</td>
            </tr>
            <tr>
                <td><strong>No. Resi</strong></td>
                <td>{{$pesanan_penjualan->resi}}</td>
            </tr>
        </table>
        ...
        <table style="width: 100%; margin-top: 10px">
            <tr>
                ...
                <td style="vertical-align: text-top;" rowspan="2">
                    Note : 
                    <p>{{ $pesanan_penjualan->keterangan }}</p>
                </td>
            </tr>
