                ...
                <div class="col-md-6">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>Nama pemesan</td>
                            <td>
                                <input name="nama_pelanggan" id="nama_pemesan" value="" type="text" class="form-control bg-light" readonly>
                            </td>
                        </tr>
                        <tr>
                            <td>Alamat pemesan </td>
                            <td>
                                <textarea name="alamat_pelanggan" id="alamat_pemesan" cols="30" rows="5" class="form-control bg-light"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                ...
                <div class="col-md-6">
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td>
                                <input name="nomer_pesanan_penjualan" type="text" class="form-control bg-light" value="{{$nomer}}" readonly>
                            </td>
                        </tr>
                        <tr>
                            <td>Tanggal*</td>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody class="rincian-produk">
                        <tr>
                            ...
                            <td>
                                <input name="harga_produk[]" type="text" id="harga-produk-0" class="form-control harga-produk" required>
                            </td>

                            <td>
                                <input name="diskon_persen[]" type="number" min="0" step="0.1" max="100" class="form-control diskon-persen" value="0">
                                <input name="diskon_nominal[]" type="text" id="diskon-nominal-0" class="form-control diskon-nominal bg-light" value="0" readonly>
                            </td>

                            <td>
                                <input name="potongan[]" type="text" id="potongan-0" class="form-control potongan" value="0">
                                <input name="cashback[]" type="text" id="cashback-0" class="form-control cashback" value="0">
                            </td>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="biaya_kirim" class="form-control biaya-kirim" value="0">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Grand total</td>
    ...
    $(document).ready(function() {
        ...
        $btnTambahRow.click(function() {
            ...
            const row = `<tr>
                            ...
                            <td>
                                <input name="diskon_persen[]" type="number" min="0" step="0.1" max="100" class="form-control diskon-persen" value="0">
                                <input name="diskon_nominal[]" type="text" id="diskon-nominal-${index}" class="form-control diskon-nominal bg-light" value="0" readonly>
                            </td>
