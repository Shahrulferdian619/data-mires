    ...
    <div style="width:100%; padding:10px; border: 1px solid black">
        ...
        <table style="width: 100%; margin-top: 10px">
            <tr>
                ...
                <td>{{ $konsinyasi->pelanggan->nama_pelanggan }}</td>
                <td><strong>No. Surat Jalan</strong></td>
                <td>{{ $nomer_sj }}</td>
            </tr>
            <tr>
                <td><strong>Alamat Customer</strong></td>
                <td>{{ $konsinyasi->pelanggan->detil_alamat }}</td>
                <td><strong>Tanggal Surat Jalan</strong></td>
                <td>{{ date('d-m-Y', strtotime($konsinyasi->tanggal_kirim)) }}</td>
            </tr>
            <tr>
                <td><strong>No. Telp</strong></td>
                <td>{{ $konsinyasi->pelanggan->no_handphone }}</td>
                <td><strong>No. Konsinyasi</strong></td>
                <td>{{ $konsinyasi->nomer_konsinyasi }}</td>
            </tr>
            <tr>
                <td><strong>Ekspedisi</strong></td>
                <td>{{ $konsinyasi->ekspedisi }}</td>
                <td><strong>Tanggal Konsinyasi</strong></td>
        ...
        <table style="width: 100%; margin-top: 10px">
            <tr>
                ...
                <td style="vertical-align: text-top;" rowspan="2">
                    Note : 
                    <p>{{ $konsinyasi->alamat_penerima }}</p>
                </td>
            </tr>
