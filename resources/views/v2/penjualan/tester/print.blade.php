...
<head>
    <title>Permintaan tester : {{ $tester->nomer_permintaan_tester }}</title>
    <meta charset="UTF-8">
    ...
    <div style="width:100%; padding:10px; border: 1px solid black">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="text-align: center; font-size: 12; color: white; background-color: #3bb4cc" colspan="2">
                    <strong>PERMINTAAN TESTER</strong>
                </td>
            </tr>

            <tr>
                <td style="width: 15%;"><strong>No. Permintaan</strong></td>
        ...
        <table style="width: 100%; margin-top: 10px">
            ...
            <tr>
                ...
                <td>{{ $tester->pelanggan->detil_alamat }} {{ $tester->pelanggan->provinsi }}</td>
            </tr>
            <tr>
