...
<a href="{{ route('invoice-konsinyasi.index') }}">
    <i class="fa fa-arrow-left"></i> Kembali ke daftar
</a>

<hr>

<form action="{{route('invoice-konsinyasi.store')}}" method="post" enctype="multipart/form-data">
    @csrf
    <!-- Data Pelanggan -->
    <div class="card">
        ...
        <div class="card-body">
            ...
            <select name="pelanggan" class="form-control select2 select-pelanggan" required>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <label for="">Nomer invoice konsinyasi</label>
            <input name="nomer_invoice_konsinyasi" type="text" class="form-control" required>
            ...
            <select name="ppn" class="form-control select-ppn" required>
                <option value="">-- PILIH PPN SALAH SATU --</option>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <select name="gudang" class="form-control select2" required>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody class="rincian-produk">
                        <tr>
                            ...
                            <td>
                                <input name="diskon_nominal[]" type="text" class="form-control diskon-nominal">
                            </td>
    ...
    <div class="card">
        <div class="card-footer">
            ...
            <a href="{{ route('invoice-konsinyasi.index') }}" class="btn btn-outline-warning">
                Batal
            </a>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // hitung ulang diskon produk setiap ada perubahan input
        $(document).on('input', '.diskon-persen', function(e) {
            //hitungDiskonProduk();
            hitungTotal();
        });

        // hitung ulang diskon global setiap ada perubaha input
        ...
        function validateInput() {
            $('.kuantitas, .harga-produk, .diskon-persen').on('input', function() {
                let value = parseFloat($(this).val());

                if (isNaN(value) || value < 0) {
                    $(this).val(1);
                } else if ($(this).hasClass('diskon-persen') && value > 100) {
                    $(this).val(1);
                }
            });
        }
