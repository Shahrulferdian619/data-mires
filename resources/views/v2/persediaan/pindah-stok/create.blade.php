...
<form action="{{route('pindah-stok.store')}}" method="post" enctype="multipart/form-data">
    @csrf
    <!-- Data Pindah stok -->
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input name="nomer_ref" type="text" class="form-control" required>
                ...
                <div class="col-md-6">
                    ...
                    <textarea name="keterangan" id="" cols="30" rows="8" class="form-control"></textarea>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody class="rincian-produk">
                        <tr class="rincian-produk-0">
                            <td>
                                <select name="rincian[0][produk_id]" class="form-control select2" required>
                                    <option value="">-- CARI PRODUK --</option>
                                    @foreach($data['produk'] as $produk)
                                    <option value="{{$produk->id}}">{{$produk->kode_barang}} | {{$produk->nama_barang}}</option>
                                    @endforeach
                                </select>
                            </td>

                            <td>
                                <input name="rincian[0][kuantitas]" type="number" min="1" class="form-control kuantitas" value="1" required>
                            </td>

                            <td>
                                <input name="rincian[0][catatan]" type="text" class="form-control">
                            </td>
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            ...
                            <select name="paket_id" class="form-control">
                                ...
                                <option value="{{ $paket->id }}">{{ $paket->packet_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-2">
