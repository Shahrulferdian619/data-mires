...
<head>
    <title>Pindah barang : {{ $pindah_stok->nomer_ref }}</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div style="width:100%; padding:10px; border: 1px solid black">
        <table style="width: 100%;">
            <tr>
                ...
                <td style="text-align: center; font-size: 12; color: white; background-color: #3bb4cc" colspan="2">
                    <strong>PINDAH STOK</strong>
                </td>
            </tr>

            <tr>
                <td style="width: 15%;"><strong>No. ref</strong></td>
        ...
        <table style="width: 100%; margin-top: 10px">
            <tr>
                <td style="width: 20%;"><strong>Gudang asal</strong></td>
