...
<form action="{{route('pembelian.invoice-pembelian.store')}}" method="post" enctype="multipart/form-data">
    @csrf
    <!-- Data Pesanan -->
    <div class="card">
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-striped">
                    <tr>
                        ...
                        <td>
                            <select name="pesanan_pembelian_id" class="form-control select2 pesanan-pembelian" required>
                                <option value="">-- cari pesanan pembelian --</option>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="nomer_invoice_pembelian" class="form-control" placeholder="Ex: INV/1000" required>
                        </td>
                    </tr>
                    <tr>
                        <td>Tanggal*</td>
                    ...
                    <tr>
                        <td>Keterangan</td>
                        <td>
                            <textarea name="" cols="30" rows="5" class="form-control" placeholder="Opsional"></textarea>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td>Biaya kirim</td>
                        <td>
                            <input type="text" name="biaya_kirim" class="form-control biaya-kirim" id="biaya-kirim" value="0">
                        </td>
                    </tr>
                    <tr>
                        <td>Dsc global(%)</td>
                        <td>
                            <input type="number" name="diskon_persen_global" class="form-control diskon-persen-global" min="0" step="0.01" value="0">
                        </td>
                    </tr>
                    <tr>
                        <td>Dsc global(Rp)</td>
                    ...
                    <tr>
                        <td>
                            <input type="text" name="pajaklain1_keterangan" class="form-control" placeholder="Pajak lain 1 (masukkan persen)">
                        </td>
                        <td>
                            <input type="number" name="pajaklain1_persen" class="form-control pajaklain1-persen" min="0" step="0.01" value="0">
