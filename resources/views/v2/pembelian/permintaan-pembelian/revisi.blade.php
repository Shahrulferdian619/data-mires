...
<form action="{{route('pembelian.permintaan-pembelian.proses-revisi',$permintaan->id)}}" method="post" enctype="multipart/form-data">
    @csrf
    @method('patch')
    <!-- Data Permintaan -->
    <div class="card">
            ...
            <div class="col-md-6">
                <table class="table table-borderless">
                    ...
                    <tr>
                        <td>Berkas</td>
                        <td>
                            <a href="{{ route('pembelian.permintaan-pembelian.download-berkas',$berkas->nama_berkas) }}">{{ $berkas->nama_berkas }}</a>
                        </td>
                    </tr>
                    @endforeach
                </table>
