...
<form action="{{route('pembelian.pesanan-pembelian.store')}}" method="post" enctype="multipart/form-data">
    @csrf
    <!-- Data Pesanan -->
    <div class="card">
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-striped">
                    <tr>
                        ...
                        <td>
                            <select name="permintaan_pembelian_id" class="form-control select2 permintaan-pembelian" required>
                                <option value="">-- cari permintaan pembelian --</option>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="nomer_pesanan_pembelian" class="form-control" placeholder="Ex: PO/I/2023/00001" required>
                        </td>
                    </tr>
                    <tr>
                        <td>Tanggal*</td>
