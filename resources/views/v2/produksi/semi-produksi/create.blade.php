...
<form action="{{route('produksi.semi-store')}}" method="post" enctype="multipart/form-data">
    @csrf
    <!-- Data Permintaan -->
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="text" name="nomer_produksi" class="form-control" required value="{{ old('nomer_produksi') }}">
                ...
                <div class="col-md-6">
                    ...
                    <textarea name="keterangan" cols="30" rows="4" class="form-control" placeholder="kosongkan bila tidak perlu">{{ old('keterangan') }}</textarea>
                </div>
            </div>
        </div>
    </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody class="rincian-produk">
                        ...
                        @else
                            <tr class="rincian-0">
                                <td>
                                    <select name="rincian[0][barang_id]" class="form-control select-item">
                                ...
                                <td>
                                    <input name="rincian[0][kuantitas]" type="number" class="form-control" min="1" value="1">
                                </td>
                                <td>
                        ...
                        <tr>
                            <td>
                                <select name="barang_id" class="form-control select-item">
                                    ...
                                    @foreach ($barang as $data)
                                        <option value="{{ $data->id }}" @if (old('barang_id') == $data->id)
                                            selected
                            ...
                            <td>
                                <input name="kuantitas" type="number" class="form-control" min="1" value="{{ old('kuantitas') ?: 1}}">
                            </td>
                            <td>
                                <input name="catatan" type="text" value="{{old('catatan')}}" class="form-control" placeholder="opsional">
                            </td>
                        </tr>
                    </tbody>
                </table>
