                        ...
                        <div class="table-responsive">
                            <table class="table" id="flag">
                                ...
                                <tbody class="flag_row">
                                    <tr>
                                        <td>
                                            <select class="selectNya form-control form-control-lg" name="kredit_coa_id[]" required>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.penerimaan.index') }}" class="btn btn-outline-danger">Batal</a>
                    </div>
                </div>
            </div>
        </div>  
...
<script type="text/javascript">
    ...
    $('.btn-item').on('click', function() {
        ...
        '<tr class="flag_'+flag+'">'+
            '<td>'+
                '<select class="selectNya form-control" name="kredit_coa_id[]" required>'+
                    '<option value="">-- PILIH AKUN --</option>'+
                    @foreach($coaKredit as $row)
                        '<option value="{{ $row->id }}">[{{ $row->nomer_coa }}] - {{ $row->nama_coa }}</option>'+
                    @endforeach
