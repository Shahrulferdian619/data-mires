...
<html>
<head>
	<title>Laporan Penerimaan | PT MIRES MAHISA GLOBALINDO</title>
...
<body>
    ...
    <div style="width:100%; text-align: center; margin-bottom: 10px; margin-top: -20px"><strong style="font-size: 20px;">PENERIMAAN</strong> </div>
	...
	<table class="table table-bordered table-sm" style="width:100%">
		<thead>
			<tr class="text-center-row">
				...
				<th style="width:25%">Nomer Penerimaan</th>
				<th style="width:25%">Tanggal</th>
				<th style="width:25%">Deskripsi</th>
				<th style="width:30%">Total Nomial</th>
			</tr>
		</thead>
		<tbody>
			@php $i=1 @endphp
			@foreach($bukuBank as $row)
			<tr>
