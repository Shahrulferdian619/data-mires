...
<html>
<head>
	<title>Laporan Permintaan Pembelian | PT MIRES MAHISA GLOBALINDO</title>
...
<body>
    ...
    <center>
		<table class="center">
			<tr>
				<!-- <td><img style="margin-top: 15px;" src="http://altamasoft.tech/vuexy/images/logo/logopdf.png" width="100" height="66"></td> -->
			<!-- <img style="height: 100px; margin-left: 30px;" src="http://altamasoft.tech/img/kop-mires.png" alt=""> -->
			<td><img style="margin-top: 15px;" src="https://miresmahisa.com/vuexy/images/logo/logopdf.png" width="100" height="66"></td>
    ...
    <div style="width:100%; text-align: center; margin-bottom: 10px; margin-top: -20px"><strong style="font-size: 20px;">PERMINTAAN PEMBELIAN</strong> </div>
	...
	<table class="table table-bordered table-sm" style="width:100%">
		<thead>
			<tr class="text-center-row">
				...
				<th style="width:45%">Nomor Permintaan</th>
