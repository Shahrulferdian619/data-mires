...
<html>
<head>
	<title>Laporan Penerimaan Barang | PT MIRES MAHISA GLOBALINDO</title>
...
<body>
    ...
    <div style="width:100%; text-align: center; margin-bottom: 10px; margin-top: -20px"><strong style="font-size: 20px;">PENERIMAAN BARANG</strong> </div>
	...
	<table class="table table-bordered table-sm" style="width:100%">
		<thead>
			<tr class="text-center-row">
				...
				<th style="width:15%">Nomer Penerimaan Pesan (RI)</th>
				<th style="width:15%">Tanggal Penerimaan</th>
				<th style="width:25%">Keterangan</th>
				<th style="width:20%">Supplier</th>
                <th style="width:20%">Nomer Pesanan (PO)</th>
			</tr>
		</thead>
		<tbody>
			@php $i=1 @endphp
