...
<html>
<head>
	<title>Laporan Barang | PT MIRES MAHISA GLOBALINDO</title>
...
<body>
  ...
  vertical-align: middle;
    ...
    <div style="width:100%; text-align: center; margin-bottom: 10px; margin-top: -20px"><strong style="font-size: 20px;">BARANG</strong> </div>
	...
	<table class="table table-bordered table-sm" style="width:100%">
		<thead>
			<tr class="text-center-row">
				...
				<th style="width:10%">Nama Kategori Barang</th>
				<th style="width:17%;">Deskripsi Barang</th>
				<th style="width:5%">Satuan Barang</th>
				<th style="width:8%">Harga Barang 1</th>
				<th style="width:8%">Harga Barang 2</th>
				<th style="width:8%">Harga Barang 3</th>
				<th style="width:8%">Harga Barang 4</th>
				<th style="width:8%">Harga Barang 5</th>
			</tr>
		</thead>
		<tbody>
			@php $i=1 @endphp
			...
			<tr>
                ...
                <td>@currency($brg->harga_barang2)</td>
                <td>@currency($brg->harga_barang3)</td>
                <td>@currency($brg->harga_barang4)</td>
                <td>@currency($brg->harga_barang5)</td>
			</tr>
			@endforeach
		</tbody>
	</table>
