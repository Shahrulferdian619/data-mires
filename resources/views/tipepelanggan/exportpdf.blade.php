...
<body>
    ...
    <div style="width:100%; text-align: center; margin-bottom: 10px; margin-top: -20px"><strong style="font-size: 20px;">TIPE PELANGGAN</strong> </div>
	...
	<table class="table table-bordered table-sm" style="width:100%">
		<thead>
			<tr class="text-center-row">
				...
				<th style="width:45%">Nama Tipe Pelanggan</th>
				<th style="width:50%">Deskripsi Tipe Pelanggan</th>
			</tr>
		</thead>
		<tbody>
			@php $i=1 @endphp
