...
<html>
<head>
	<title>Laporan Pemasok | PT MIRES MAHISA GLOBALINDO</title>
...
<body>
  ...
  vertical-align: middle;
    ...
    <div style="width:100%; text-align: center; margin-bottom: 10px; margin-top: -20px"><strong style="font-size: 20px;">PEMASOK</strong> </div>
	...
	<table class="table table-bordered table-sm" style="width:100%">
		<thead>
			<tr class="text-center-row">
				...
				<th style="width:10%;">Tipe Supplier</th>
				<th style="width:10%;">Handphone Supplier</th>
				<th style="width:10%;">Email Supplier</th>
				<th style="width:17%;">Region</th>
				<th style="width:10%;">Detail Alamat</th>
				<th style="width:10%;">Deskripsi Supplier</th>
			</tr>
		</thead>
		<tbody>
			@php $i=1 @endphp
