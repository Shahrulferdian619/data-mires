...
<body>
    ...
    <table style="width: 100%" class="text-center">
        ...
        <tr>
            ...
            <td rowspan="2" style="background-image: url('{{ $purchasing_signature }}');
            ...
            @if($total >= 5000000)
            <td rowspan="2" style="background-image: url('{{ $komisaris_signature }}');
                                background-size: cover;
                                background-position: center;
                                background-repeat: no-repeat;">
                <br><br><br><br><br><br>
            ...
            @endif
            <td rowspan="2" style="background-image: url('{{ $directur_signature }}');
                                background-size: cover;
                                background-position: center;
                                background-repeat: no-repeat;">
                <br><br><br><br><br><br>
