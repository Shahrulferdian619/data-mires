...
!(function (e, t) {
                      ...
                      : function (t, n, l) {
                            ...
                            if (m) {
                                ...
                                if (((d = [a ? m.firstChild : m.lastChild]), a && v)) {
                                    for (
                                        b = (h = (c = (u = (p = (f = m)[x] || (f[x] = {}))[f.uniqueID] || (p[f.uniqueID] = {}))[e] || [])[0] === _ && c[1]) && c[2], f = h && m.childNodes[h];
                                    ...
                                    for (
                                        ;
                                        (f = (++h && f && f[g]) || (b = h = 0) || d.pop()) &&
                                        ((s ? f.nodeName.toLowerCase() !== y : 1 !== f.nodeType) || !++b || (v && ((u = (p = f[x] || (f[x] = {}))[f.uniqueID] || (p[f.uniqueID] = {}))[e] = [_, b]), f !== t));
      ...
      return (
          ...
          (a = se.tokenize = function (e, t) {
              ...
              for (s = e, l = [], c = i.preFilter; s; ) {
                  ...
                  i.filter))
                      !(o = $[a].exec(s)) || (c[a] && !(o = c[a](o))) || ((n = o.shift()), r.push({ value: n, type: a, matches: o }), (s = s.slice(n.length)));
                  if (!n) break;
              }
  ...
  function be(e, t, n, i, o) {
      ...
      for (p.textContent = "", h = 0; (r = f[h++]); )
          ...
          else if (((c = oe(r)), (a = me(p.appendChild(r), "script")), c && ye(a), n)) for (u = 0; (r = a[u++]); ) de.test(r.type || "") && n.push(r);
      return p;
  }
  var xe = /^([^.]*)(?:\.(.+)|)/;
  function we() {
              ...
              for (
                  ...
                  (h = g = (s = xe.exec(t[c]) || [])[1]),
                      ...
                      h &&
                          ...
                          (p = w.event.special[h] || {}),
                          (u = w.extend({ type: h, origType: g, data: i, handler: n, guid: n.guid, selector: o, needsContext: o && w.expr.match.needsContext.test(o), namespace: d.join(".") }, r)),
  ...
  function je(e, t, n, i) {
      ...
      if (f && ((a = (o = be(t, e[0].ownerDocument, !1, e, i)).firstChild), 1 === o.childNodes.length && (o = a), a || i)) {
          for (l = (s = w.map(me(o, "script"), Oe)).length; p < f; p++) (c = o), p !== g && ((c = w.clone(c, !0, !0)), l && w.merge(s, me(c, "script"))), n.call(e[p], c, p);
          if (l)
  ...
  function qe(e, t, n) {
      ...
      return (
          (n = n || Pe(e)) &&
              ...
              !h.pixelBoxStyles() && Ie.test(a) && He.test(t) && ((i = s.width), (o = s.minWidth), (r = s.maxWidth), (s.minWidth = s.maxWidth = s.width = a), (a = n.width), (s.width = i), (s.minWidth = o), (s.maxWidth = r))),
          void 0 !== a ? a + "" : a
      );
  }
  function Fe(e, t) {
  ...
  function lt(e, t, n) {
      for (var i, o = (ct.tweeners[t] || []).concat(ct.tweeners["*"]), r = 0, a = o.length; r < a; r++) if ((i = o[r].call(n, t, e))) return i;
  }
  function ct(e, t, n) {
      var i,
          o,
          ...
          l = function () {
              if (o) return !1;
              for (var t = Ze || at(), n = Math.max(0, c.startTime + c.duration - t), i = 1 - (n / c.duration || 0), r = 0, a = c.tweens.length; r < a; r++) c.tweens[r].run(i);
          ...
          ajax: function (t, n) {
              ...
              function T(t, n, a, l) {
                  ...
                  c ||
                      ...
                      !p && -1 < w.inArray("script", h.dataTypes) && w.inArray("json", h.dataTypes) < 0 && (h.converters["text script"] = function () {}),
                      (x = (function (e, t, n, i) {
                          var o,
                              r,
                              a,
                      ...
                      p
                          ? (h.ifModified && ((_ = E.getResponseHeader("Last-Modified")) && (w.lastModified[o] = _), (_ = E.getResponseHeader("etag")) && (w.etag[o] = _)),
                            204 === t || "HEAD" === h.type ? (k = "nocontent") : 304 === t ? (k = "notmodified") : ((k = x.state), (f = x.data), (p = !(m = x.error))))
                          ...
                          return function () {
                              n &&
                                  ...
                                  "abort" === e
                                      ...
                                      : r(Wt[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? { binary: s.response } : { text: s.responseText }, s.getAllResponseHeaders()));
                          };
                      }),
                          (s.onload = n()),
  ...
  w.ajaxSetup({
      ...
      (h.createHTMLDocument = (((Ut = m.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === Ut.childNodes.length)),
                          ...
                          var s,
                              ...
                              h = (function (e, t) {
                                  var n = e.offsets,
                                      ...
                                      f = t ? r : a;
                                  return { left: p(1 == s % 2 && 1 == l % 2 && !u && t ? i.left - 1 : i.left), top: f(i.top), bottom: f(i.bottom), right: p(i.right) };
  ...
  (function (e, t, n, i) {
      ...
      function T(e) {
          for (var t = [], n = 0; n < e.pointers.length; ) (t[n] = { clientX: se(e.pointers[n].clientX), clientY: se(e.pointers[n].clientY) }), n++;
          ...
          l(M, _, {
              handler: function (e) {
                  ...
                  o & be && (0 === e.button || a) ? 0 > s && (t.push(e), (s = t.length - 1)) : o & (we | _e) && (n = !0),
                      0 > s || ((t[s] = e), this.callback(this.manager, o, { pointers: t, changedPointers: [e], pointerType: r, srcEvent: e }), n && t.splice(s, 1));
              },
          });
      ...
      (z.prototype = {
          ...
          (Z.defaults = {
              ...
              inputTarget: null,
              inputClass: null,
              preset: [[K, { enable: !1 }], [$, { enable: !1 }, ["rotate"]], [G, { direction: Ae }], [V, { direction: Ae }, ["swipe"]], [J], [J, { event: "doubletap", taps: 2 }, ["tap"]], [Q]],
  ...
  function () {
          ...
          v = {
              ...
              G.prototype.trigger = function () {
                  ...
                  if (null != (i = this.bindings) && i[a]) {
                      for (n = 0, r = []; n < this.bindings[a].length; ) (t = (o = this.bindings[a][n]).handler), (e = o.ctx), (o = o.once), t.apply(null != e ? e : this, s), o ? r.push(this.bindings[a].splice(n, 1)) : r.push(n++);
                      return r;
                  }
              },
              Y = G,
      ...
      Q(J, (Y = Error)),
          ...
          (Z.prototype.render = function () {
              ...
              for (e = this.getElement(), i = "translate3d(" + this.progress + "%, 0, 0)", o = 0, r = (s = ["webkitTransform", "msTransform", "transform"]).length; o < r; o++) (t = s[o]), (e.children[0].style[t] = i);
              return (
          ...
          (T = function () {
              var e, t, i, o, r, s, u, p;
              for (a.sources = I = [], t = 0, o = (s = ["ajax", "elements", "document", "eventLag"]).length; t < o; t++) !1 !== C[(e = s[t])] && I.push(new l[e](C[e]));
              ...
              if ((((t = t || {}).wait = t.wait || 0), (t.position = t.position || null), n))
                  for (
                      ...
                      var u = e[o],
                          ...
                          f = a(u);
                      (i.x = f.left + p.x), (i.y = f.top + p.y), (s.pageX = i.x), (s.pageY = i.y), l.show(s, u), 0 <= t.wait && null !== t.wait && setTimeout(c({ type: "mouseup", button: 1 }, u), t.wait);
                  }
          }),
          (e.calm = function (e) {
                      ...
                      },
                      {
                          ...
                          value: function (e, t, i, o, r) {
                              ...
                              this.services.utils && this.services.utils.hasLoadedNamespace && !this.services.utils.hasLoadedNamespace(t)
                                  ...
                                  : null != i && "" !== i && (this.backend && this.backend.create && this.backend.create(e, t, i, o, null, n({}, a, { isUpdate: r })), e && e[0] && this.store.addResource(e[0], t, i, o));
                          },
                      },
                  ]),
                  t
                      ...
                      value: function () {
                          ...
                          if (
                              ...
                              (s.logger = f),
                                  ...
                                  (s.languageUtils = a),
                                  (s.pluralResolver = new M(a, { prepend: this.options.pluralSeparator, compatibilityJSON: this.options.compatibilityJSON, simplifyPluralSuffix: this.options.simplifyPluralSuffix })),
...
*/ !(function () {
          ...
          function (e, t, n) {
              ...
              e.exports = function (e) {
                  var t,
                      ...
                      y = 0,
                      v = c(f);
                  if ((m && (g = i(g, d > 2 ? arguments[2] : void 0, 2)), null == v || (h == Array && a(v)))) for (n = new h((t = s(f.length))); t > y; y++) l(n, y, m ? g(f[y], y) : f[y]);
          ...
          function (e, t, n) {
              ...
              e.exports = function (e, t, n, u, h, v, b) {
                  ...
                  if (
                      (L && ((x = r(L.call(new e()))), d !== Object.prototype && x.next && (p || r(x) === d || (a ? a(x, d) : "function" != typeof x[m] && l(x, m, y)), s(x, E, !0, !0), p && (f[E] = y))),
                      "values" == h &&
                          C &&
                          "values" !== C.name &&
                          ((T = !0),
